...
describe('Lib Advanced Coverage', () => {
    describe('export', () => {
        ...
        it('exportOrdersToCSV should download CSV', () => {
            const orders: any[] = [{
                id: '1', customer: { name: 'C1' }, status: 'PENDING', createdAt: new Date(), dueDate: new Date(),
                totalValue: 100, items: []
            }];
        ...
        it('exportProductsToCSV should download CSV', () => {
            const products: any[] = [{
                id: '1', name: 'P1', laborTime: 60, profitMargin: 50, materials: []
            }];
        ...
        it('exportMaterialsToCSV should download CSV', () => {
            const materials: any[] = [{
                id: '1', name: 'M1', unit: 'kg', cost: 10, quantity: 100, minQuantity: 10
            }];
        ...
        it('exportCustomersToCSV should download CSV', () => {
            const customers: any[] = [{
                id: '1', name: 'Cust1', phone: '123', email: 'e@e.com', address: 'Addr'
            }];
        ...
        it('exportFinancialReportToCSV should download CSV with correct calculations', () => {
            const orders: any[] = [{
                id: '1', customer: { name: 'C1' }, createdAt: new Date(), totalValue: 100,
                items: [{
                    quantity: 1,
                    product: {
