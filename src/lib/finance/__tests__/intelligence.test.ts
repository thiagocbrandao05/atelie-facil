...
import { analyzeProfitability, calculatePriceForTargetProfit, applyPsychologicalPricing } from '../intelligence'
...
describe('Finance Intelligence', () => {
    ...
    describe('applyPsychologicalPricing', () => {
        it('should format to .90', () => {
            ...
            expect(applyPsychologicalPricing(10.00, '90').toNumber()).toBe(10.9)
        })
        ...
        it('should format to .97', () => {
            expect(applyPsychologicalPricing(7.40, '97').toNumber()).toBe(7.97)
        })
    })
})
