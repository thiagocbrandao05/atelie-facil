...
export default async function PedidosPage(props: {
  ...
  const [{ data: orders, totalPages, page: currentPage }, allOrders, products, customers] =
    await Promise.all([getOrdersPaginated(page), getOrders(), getProducts(), getCustomers()])
