  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Métricas e insights do seu negócio</p>
      </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Total de Pedidos (30d)</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Receita (30d)</p>
                  <p className="text-2xl font-bold">
                    R${' '}
                    {Number(salesMetrics.totalRevenue).toLocaleString('pt-BR', {
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-muted-foreground text-sm">Status dos Pedidos</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">Alertas de Estoque Baixo</p>
                <p className="text-warning text-3xl font-bold">{inventoryMetrics.lowStockCount}</p>
              </div>
              <div>
                <p className="text-muted-foreground text-sm">Valor Total do Estoque</p>
                <p className="text-3xl font-bold">
                  R${' '}
                  {Number(inventoryMetrics.totalValue).toLocaleString('pt-BR', {
                    minimumFractionDigits: 2,
                  })}
                </p>
              </div>
                  ...
                  <div key={product.productId} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">{product.quantity} unidades</p>
                      </div>
                    </div>
